    ...
    <div class="container mx-auto px-4">
        <div class="text-center">
            <h1 class="text-4xl font-bold text-text-main mb-4">
                Get in <span class="text-eco-green">Touch</span>
            </h1>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    <h2 class="text-2xl font-bold text-text-main mb-6">Send a Message</h2>
                    ...
                    <form action="/contact" method="POST" class="space-y-6">
                        ...
                        <!-- Subject Field -->
                        <div>
                            <label for="subject" class="block text-sm font-semibold text-text-main mb-2">
                                Subject
                            </label>
                            <input 
                                type="text" 
                        ...
                        <!-- Message Field -->
                        <div>
                            <label for="message" class="block text-sm font-semibold text-text-main mb-2">
                            ...
                            <textarea 
                                ...
                                rows="5"
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-eco-green focus:border-transparent transition-all resize-none"
                        ...
                        <button 
                            type="submit" 
                            class="w-full px-6 py-4 bg-cta-accent hover:bg-yellow-500 text-white font-semibold rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2"
                        >
                        ...
                        @if(session('success'))
                        <div class="bg-success/10 border border-success text-success px-4 py-3 rounded-lg flex items-center space-x-2">
                        ...
                        @if(session('error'))
                        <div class="bg-error/10 border border-error text-error px-4 py-3 rounded-lg flex items-center space-x-2">
                            <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        <h2 class="text-2xl font-bold text-text-main mb-6">Contact Information</h2>
                    ...
                    <!-- FAQ Quick Links -->
                    <div class="bg-gradient-to-br from-eco-green to-green-700 text-white rounded-xl shadow-lg p-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-green-100 text-sm">30-day return policy on all products</p>
                            </div>
                            <div>
                                <h4 class="font-semibold mb-1">Eco Certification</h4>
                                <p class="text-green-100 text-sm">All materials verified by third-party auditors</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Social Media -->
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        <h3 class="text-xl font-bold text-text-main mb-4">Follow Us</h3>
                        <p class="text-text-muted text-sm mb-4">
                            Stay updated with new products and sustainability tips
                        </p>
                        <div class="flex space-x-3">
                            <a href="#" class="w-10 h-10 bg-eco-green hover:bg-green-700 rounded-lg flex items-center justify-center transition-colors">
