<div class="container mx-auto px-4 py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="/prodwiyat" class="hover:text-eco-green transition-colors">Shop</a></li>
        ...
        <!-- Contact Info -->
        <div>
            <h3 class="font-semibold mb-4 text-eco-green">Contact</h3>
            <ul class="space-y-2 text-sm text-gray-400">
            ...
            <div class="flex space-x-3 mt-4">
                <a href="#" class="w-8 h-8 bg-gray-700 hover:bg-eco-green rounded-full flex items-center justify-center transition-colors">
    ...
    <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
        <p>&copy; {{ date('Y') }} Store4u. All rights reserved. Made with <span class="text-eco-green">♥</span> for athletes.</p>
    </div>
</div>